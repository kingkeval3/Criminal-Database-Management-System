...
import java.sql.*;
public class fir_analysis extends GenericServlet
{
	Connection con;
...
ServletResponse response) throws ServletException,IOException
{
	...
	try
	{
	PreparedStatement st=con.prepareStatement("select * from fir");
   
   
	ResultSet rs=st.executeQuery();
	pw.print("<link rel=\"stylesheet\" href=\"assets/css/table2.css\" />");
	pw.print("<body background='C:/Eclipse/project/WebContent/images/fir1.jpg'>");
	pw.print("<div class=\"w3-container\">");
		pw.print("<center><table   width='50%'  height='50%'    border='1' >");
		pw.print("<tr class=\"w3-light-grey w3-hover-yellow\">");
	pw.print("<th>"+"FIR ID"+"</th>");
	pw.print("<th>"+"FIR DESC"+"</th>");
	...
	String fir_desc=rs.getString("fir_desc");
